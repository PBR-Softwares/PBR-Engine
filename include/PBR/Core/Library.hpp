...
namespace   PBR
{
    namespace   Core
    {
        ...
        class Library
        {
            ...
            protected:
                ///
                /// \brief Getter of the resource container, only accessible for child class.
                ///
                std::map<Key, Resource>   &resources(void);

                ///
                /// \brief Const getter of the resource container, only accessible for child class.
                ///
                const std::map<Key, Resource>   &resources(void) const;
        ...
        template<typename Key, typename Resource>
        std::map<Key, Resource> &
        Library<Key, Resource>::resources(void)
        {
            return this->m_resources;
        }

        template<typename Key, typename Resource>
        const std::map<Key, Resource> &
        Library<Key, Resource>::resources(void) const
        {
            return this->m_resources;
        }
    }
