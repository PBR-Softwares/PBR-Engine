...
FUNCTION(CXX_TEST name sources)
    ...
    IF (MSVC)
        ...
        TARGET_COMPILE_OPTIONS(${name} PRIVATE $<$<CONFIG:Release>:/MT>)
    ...
    TARGET_LINK_LIBRARIES(${name} ${CMAKE_BINARY_DIR}/${CMAKE_FIND_LIBRARY_PREFIXES}${CMAKE_PROJECT_NAME}${CMAKE_SHARED_LIBRARY_SUFFIX})
    ADD_TEST(${name} ${name})
